...
export const TEMPLATE_CATALOG: Record<DeckTemplateId, TemplateCatalogEntry> = {
  apex: {
    ...
    description: "Bento pitch: чёрный фон, lime-акцент, крупные плитки",
    frameGradient: "linear-gradient(165deg, #050505 0%, #0a0a0a 42%, #080808 100%)",
    gridBg: "none",
    accent: "#C8F31E",
  ...
  swiss: {
    ...
    description: "Bento-карточки, метрики ROI, roadmap",
    frameGradient: "linear-gradient(165deg, #050505 0%, #0c0c0c 45%, #080808 100%)",
    gridBg: "none",
    accent: "#C8F31E",
    selectedStyle: "cosmic-dark",
    layoutEngine: "swiss",
  ...
  studio: {
    ...
    description: "Bento poster: чёрный фон, lime-акцент, крупные плитки",
    frameGradient: "linear-gradient(165deg, #050505 0%, #0a0a0a 48%, #080808 100%)",
    gridBg: "none",
    accent: "#C8F31E",
    selectedStyle: "cosmic-dark",
    layoutEngine: "apex",
