...
function buildDemoSlides(): Slide[] {
  return [
    ...
    {
      type: "market",
      title: "Рынок аренды спецтехники",
      subtitle: "От TAM до реалистичного wedge за 24 месяца",
      sectionLabel: "04 · Рынок",
      content: [
        "TAM: 10 млрд ₽ — весь рынок аренды спецтехники в РФ",
        "SAM: 1.2 млрд ₽ — города-миллионники, B2B подрядчики",
        "SOM: 80 млн ₽ — пилот в 3 городах за 24 месяца",
        "Рост: +12% YoY — удорожание техники и дефицит парка",
      ],
      visualData: {
        metrics: [
