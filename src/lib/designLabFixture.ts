...
function buildDemoSlides(): Slide[] {
  return [
    ...
    },
    {
      type: "problem",
      title: "Проблема",
      subtitle: "Дорогой инструмент простаивает",
      sectionLabel: "01 · Боль",
      content: [
        "Покупка: Владение спецтехникой невыгодно для разовых и сезонных работ",
        "Простой: Оборудование стоит 40–70% времени без загрузки",
        "Поиск: Аренда через объявления — хаос, нет гарантий и прозрачных цен",
        "Риск: Штрафы, простой и споры съедают маржу подрядчика",
      ],
      speechScript: "Подрядчики либо покупают технику в кредит, либо теряют дни на поиск аренды.",
    },
    {
      type: "solution",
      title: "Решение",
      ...
      content: [
        "Цена: от 100 ₽/час — ниже рынка на 15–25%",
        "Экономия: до 60% vs покупка при загрузке до 3 дней в неделю",
        "Лояльность: кэшбек и приоритет для повторных клиентов",
        "Онлайн: бронь, оплата и документы в одном приложении",
      ],
    ...
    },
    {
      ...
      visualData: {
        competitors: [
          { label: "Объявления", detail: "Хаос цен, нет SLA", ours: false },
          { label: "Локальный парк", detail: "Узкий ассортимент", ours: false },
          { label: "NordFlow", detail: "Почасово + страховка + онлайн", ours: true },
        ],
      },
